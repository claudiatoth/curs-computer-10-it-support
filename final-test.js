// ============================================
// TEST FINAL - Computer & Büro Teil 10: IT-Support & Fehler beheben (A2/B1)
// Claudia Toth · 15 întrebări mixte
// ============================================

const finalTestData = [
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „der Fehler"?', options: ['eroarea / greșeala', 'soluția', 'butonul'], correct: 'eroarea / greșeala', explanation: 'der Fehler = eroarea / greșeala.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „der IT-Support"?', options: ['suportul tehnic / IT', 'ecranul', 'cablul'], correct: 'suportul tehnic / IT', explanation: 'der IT-Support = suportul tehnic.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „der Neustart"?', options: ['repornirea', 'invitația', 'fundalul'], correct: 'repornirea', explanation: 'der Neustart = repornirea.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was ist „die Fehlermeldung"?', options: ['mesajul de eroare', 'soluția', 'tehnicianul'], correct: 'mesajul de eroare', explanation: 'die Fehlermeldung = mesajul de eroare.' },
    { type: 'multiple', category: '🎯 Situație', question: 'Der Computer startet nicht. Was prüfst du zuerst?', options: ['das Kabel und den Stecker', 'die Kamera', 'den Chat'], correct: 'das Kabel und den Stecker', explanation: 'Întâi verifici cablul și ștecărul.' },
    { type: 'multiple', category: '🎯 Situație', question: 'Das Programm reagiert nicht mehr. Was tust du?', options: ['den Computer neu starten', 'die Kamera kaufen', 'lauter sprechen'], correct: 'den Computer neu starten', explanation: 'Dacă se blochează, repornești calculatorul (neu starten).' },
    { type: 'multiple', category: '🎯 Situație', question: 'Das Internet geht nicht. Was hilft oft?', options: ['den Router neu starten', 'den Drucker wechseln', 'das Kabel kaufen'], correct: 'den Router neu starten', explanation: 'Repornești routerul (den Router neu starten).' },
    { type: 'multiple', category: '🎯 Situație', question: 'Nichts hilft. Was machst du?', options: ['den IT-Support anrufen', 'den PC wegwerfen', 'die Kamera einschalten'], correct: 'den IT-Support anrufen', explanation: 'Suni la IT-Support (den IT-Support anrufen).' },
    { type: 'multiple', category: '📝 Gramatică (Wenn)', question: 'Welcher Satz ist richtig?', options: ['Wenn der PC nicht startet, drück den Knopf.', 'Wenn startet der PC nicht, drück den Knopf.', 'Wenn der PC startet nicht, drück den Knopf.'], correct: 'Wenn der PC nicht startet, drück den Knopf.', explanation: 'După „wenn", verbul (startet) merge la FINAL.' },
    { type: 'multiple', category: '📝 Gramatică (Wenn)', question: 'Wann benutzt man „wann"?', options: ['nur in Fragen: „Wann kommt der Techniker?"', 'als Bedingung statt „wenn"', 'immer am Satzende'], correct: 'nur in Fragen: „Wann kommt der Techniker?"', explanation: '„wann" e DOAR pentru întrebări (când?); condiția = „wenn".' },
    { type: 'luckentext', category: '✍️ Verb (Perfekt)', question: 'Completează (separabil ab-, + sein):', sentence: 'Der Computer ist plötzlich ______. (abstürzen)', translation: 'Calculatorul s-a blocat brusc.', accept: ['abgestürzt'], correct: 'abgestürzt', explanation: 'abstürzen → ist ab-ge-stürzt (Perfekt cu sein).' },
    { type: 'luckentext', category: '✍️ Verb (Perfekt)', question: 'Completează (separabil an-, TARE):', sentence: 'Ich habe den IT-Support ______. (anrufen)', translation: 'Am sunat la IT-Support.', accept: ['angerufen'], correct: 'angerufen', explanation: 'anrufen → an-ge-rufen (Akkusativ).' },
    { type: 'luckentext', category: '✍️ Vocabular activ', question: 'Completează (a rezolva — Perfekt):', sentence: 'Das Problem ist ______. (lösen)', translation: 'Problema e rezolvată.', accept: ['gelöst', 'geloest'], correct: 'gelöst', explanation: 'lösen → gelöst.' },
    { type: 'luckentext', category: '✍️ Traducere', question: 'Tradu în germană:', sentence: '„Mă puteți ajuta, vă rog?"', translation: 'Können Sie mir bitte helfen?', accept: ['können sie mir bitte helfen', 'koennen sie mir bitte helfen', 'könnt ihr mir bitte helfen'], correct: 'Können Sie mir bitte helfen?', explanation: 'helfen cere Dativ: jemandem helfen (mir helfen).' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was rät Herr Wolf, wenn der Bildschirm schwarz bleibt?', options: ['den Knopf fünf Sekunden drücken', 'das Mikrofon einschalten', 'einen neuen PC kaufen'], correct: 'den Knopf fünf Sekunden drücken', explanation: 'Herr Wolf: „Wenn der Bildschirm schwarz bleibt, dann drücken Sie den Knopf fünf Sekunden lang."' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong>: vocabularul tehnic, problemele tipice, structura „Wenn..., dann...", verbele și înțelegerea dialogului.</p>
